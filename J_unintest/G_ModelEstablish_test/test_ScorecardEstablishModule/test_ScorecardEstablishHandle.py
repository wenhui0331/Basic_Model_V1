...
class TestScorecardEstablishClass(TestCase):
    def test_scorecard_establishment(self):
        ...
        # dataStyle = 'csv'
        # dataDictPath = 'D:/1. 泰隆工作/1. 工作资料/3.税享卡/税享卡-微众税银-建模/数据样本/指标翻译.xlsx'
        # dataPathStyle = 'excel'
        # nameMappingLeft = '变量名'
        # nameMappingRight = '解释'
        ...
        # pathSaved = 'C:/Users/Administrator/Desktop' # 数据清洗结果的存储路径 (如：'D:/1.csv' str)
        # maxNumBox = 5
        ...
        pathSaved = 'D:/15. 建模包测试结果/排查错误' # 数据清洗结果的存储路径 (如：'D:/1.csv' str)
        maxNumBox = 5
        ...
        dataForLr = SEC.scorecard_establishment(dataPath,dataStyle,dataDictPath,dataPathStyle,nameMappingLeft,nameMappingRight,dataSeparation)
